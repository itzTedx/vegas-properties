export const IconAgent = (props: SVGProps) => {
  return (
    <svg {...props} aria-hidden="true" height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
      <g fill="currentColor">
        <path
          clipRule="evenodd"
          d="M3.75 4.75H14.25C15.3546 4.75 16.25 5.64543 16.25 6.75V8.75C10.4655 10.7654 7.29122 10.7566 1.75 8.75V6.75C1.75 5.64543 2.64543 4.75 3.75 4.75Z"
          fill="currentColor"
          fillOpacity="0.3"
          fillRule="evenodd"
          stroke="none"
        />
        <path
          d="M1.75 8.75C3.171 9.366 5.716 10.253 9 10.253C12.284 10.253 14.829 9.366 16.25 8.75"
          fill="none"
          stroke="currentColor"
          strokeLinecap="round"
