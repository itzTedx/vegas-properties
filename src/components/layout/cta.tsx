...
export const Cta = ({ disableBg = false }: Props) => {
  return (
    <section
      ...
      className={cn(
        "relative bg-gradient-to-t from-50% from-brand-950 to-50% to-transparent py-8 sm:py-12 md:py-16 lg:py-20",
    ...
    >
      ...
      <div className="container relative z-10 flex max-w-7xl items-center justify-between gap-3 overflow-hidden rounded-3xl bg-card px-3 py-8 text-primary shadow-[0_8px_28px_0_oklch(0.2788_0.0909_306.27/40%)] sm:rounded-4xl sm:px-4 sm:py-12 sm:shadow-[0_12px_42px_0_oklch(0.2788_0.0909_306.27/40%)] md:px-8 md:py-16 lg:px-12">
        <div>
          <h2
            className="relative z-10 mx-auto max-w-2xl text-balance font-serif text-secondary-800 text-xl leading-[1.1] sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl"
            id="cta-heading"
          >
            Ready to Buy, Sell, or Invest in Dubai?
          </h2>
          <p className="relative z-10 mx-auto max-w-xl text-balance text-sm leading-relaxed sm:max-w-2xl sm:text-base md:text-lg lg:text-xl">
            Our team of experts is ready to guide you through every step of the process.
          </p>
        </div>
        <Button aria-label="Learn more about our services and expertise" asChild size="lg">
